    ...
    >
      <div className="flex  items-center justify-center">
        <div className="relative">
          ...
          >
            <div className=" object-cover rounded-full border-4 bg-gray-100 border-white border-opacity-40 shadow-black/[0.03] sm:h-32 sm:w-32">
              <Image
                className=" transition-all h-35  w-44 rounded-full object-cover  "
                // src={"https://avatars.githubusercontent.com/u/61672294?v=4"}
                src={
                  "https://media.licdn.com/dms/image/D5603AQGRIYega33esA/profile-displayphoto-shrink_400_400/0/1695480849829?e=1706745600&v=beta&t=dvGBTWZg5RGM_M3nzIbpRCo7w0oB0ikrgNjtnz7cmRM"
                }
                priority={true}
                alt="Krishna"
                quality={95}
      ...
      >
        <span className="font-bold">Hello, I'm Krishna.</span> I'm a student{" "}
      ...
      >
        <a href="mailto:krishnapatil45abcd@gmail.com">
        ...
        <a
          href="https://www.linkedin.com/in/krishna-bamane-a48560280/"
          target="_blank"
        ...
        <a
          href="https://github.com/krishna-1919"
          target="_blank"
