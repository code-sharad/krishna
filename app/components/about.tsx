...
function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        I am a dedicated student currently pursuing a BCS at the Vasntaro naik
        mahavidyaly. I am currently in my second year of the program, and my
        educational journey is marked by a deep passion for computer science. My
        primary area of focus is full-stack web development, and I thrive on the
        creative challenges that the world of programming presents.{" "}
